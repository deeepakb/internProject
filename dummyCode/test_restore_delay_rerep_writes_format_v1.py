...
class TestRestoreDelayRerepWrites(RestoreDelayRerepTestSuite):
    """
    ...
    def test_restore_delay_rerep_writes(self, cluster, cluster_session,
                                        db_session, vector):
        gucs = dict(
        ...
        self.restore_delay_rerep_writes(cluster, cluster_session, db_session,
                                        gucs)
