...
from test_burst_mv_ddl_tx import dimensions_no_txn
...
class TestBurstWriteMVDDLNoTxnCluster(TestBurstWriteMVDDLBase):
    @classmethod
    def modify_test_dimensions(cls):
        return dimensions_no_txn

    def test_burst_mv_ddl_no_txn_cluster(self, cluster, vector):
...
@pytest.mark.serial_only
@pytest.mark.skip_load_data
class TestBurstWriteMVDDLNoTxnSS(TestBurstWriteMVDDLBase):
    @classmethod
    def modify_test_dimensions(cls):
        return dimensions_no_txn

    def test_burst_mv_ddl_no_txn_ss(self, cluster, vector):
        self.base_test_burst_mv_ddl(cluster, vector)
