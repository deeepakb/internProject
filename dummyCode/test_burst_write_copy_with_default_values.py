...
class TestBurstCopyWithDefaultValues(TestBurstCopyWithDefaultValuesBase):
    def test_burst_write_copy_with_default_values(self, cluster, db_session):
        self.base_test_burst_write_copy_with_default_values(cluster, db_session)
