...
def lmao():
    ...
    all_nodes = [doc for doc in vector_store.docstore._dict.values() if doc.metadata.get("file_path") == "/home/deeepakb/redshift-padb/doc/doxygen/padb/versionfilter.sh"]
    print(all_nodes)
